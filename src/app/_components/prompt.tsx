export default function Prompt({plural, radio}: {plural: boolean, radio: boolean}) {
    if (!radio) {
        if (plural == true) {
            return (<p className="text-left w-full">Suppose you are offered one of these bets and could sell them instead of playing them out. What is the lowest price at which you would be willing to sell each of them?</p>)
        } else {
