...
export default function CP1_Q1({submit, bets_order}: {submit: ((formData: FormData) => void), bets_order: number[]}) {
    ...
    return (
        <div className="flex flex-col gap-5 items-center">
            ...
            <p>You are offered a ticket for a game that plays out as follows. First, a ball is drawn at random from the urn. If the drawn ball is purple or white, you receive INR {cp_bets[0][0]}. Else, you receive nothing.</p>
