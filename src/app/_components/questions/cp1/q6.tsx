...
export default function CP1_Q6({submit, bets_order}: {submit: ((formData: FormData) => void), bets_order: number[]}) {
    ...
    return (
        <div className="flex flex-col gap-5 items-center">
            ...
            <p>You are offered one of two tickets, ticket A and B, for a game that plays out as follows. First, you must draw a ball from the urn without looking. If you have ticket A, you receive INR {statements[0]} and nothing otherwise. If you have ticket B, you receive INR {statements[1]} and nothing otherwise.</p>
            ...
            <p className="text-left w-full">Which of these tickets would you choose to take?</p>
