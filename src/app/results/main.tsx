...
export default function Main({chosen_bet, pdf_pass, bet, num, proceed, mcq}: {chosen_bet: number, pdf_pass: string, bet: number, num: number, proceed: () => void, mcq: boolean}) {
    return (
        <main className="flex min-h-screen flex-col items-center gap-20 p-24 pt-16">
            ...
            <div className="flex flex-col gap-5 items-center">
                ...
                {mcq ? (
                    <h2 className="text-2xl">Since the question was an MCQ, your bet will be carried out.</h2>
                ) : (
                    <>
